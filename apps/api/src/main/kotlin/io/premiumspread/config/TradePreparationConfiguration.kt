...
/**
 * `TradePrepPolicy` 배선. 값은 [TradePreparationProperties] 가 소유하고 이 클래스는 그것을 Domain
 * 값 객체로 옮기기만 한다 — 판정 로직은 Domain 에 있다.
 *
...
@EnableConfigurationProperties(TradePreparationProperties::class)
